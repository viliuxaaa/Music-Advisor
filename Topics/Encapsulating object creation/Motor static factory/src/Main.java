...
class MotorStaticFactory {
    ...
    public static Motor make(char type, String model, long power) {
        if ("P".equalsIgnoreCase(String.valueOf(type))) {
            return new PneumaticMotor(model, power);
        } else if ("H".equalsIgnoreCase(String.valueOf(type))) {
            return new HydraulicMotor(model, power);
        } else if ("E".equalsIgnoreCase(String.valueOf(type))) {
            return new ElectricMotor(model, power);
        } else if ("W".equalsIgnoreCase(String.valueOf(type))) {
